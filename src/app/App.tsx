...
const AdminLoginPage = lazy(() => import("../app/pages/admin/AdminLoginPage").then((module) => ({ default: module.AdminLoginPage })));
const AdminDashboardLayout = lazy(() => import("../app/pages/admin/AdminDashboardLayout").then((module) => ({ default: module.AdminDashboardLayout })));
const DashboardOverview = lazy(() => import("../app/pages/admin/DashboardOverview").then((module) => ({ default: module.DashboardOverview })));
const UsersManagement = lazy(() => import("../app/pages/admin/UsersManagement").then((module) => ({ default: module.UsersManagement })));
const SkinAnalysisResults = lazy(() => import("../app/pages/admin/SkinAnalysisResults").then((module) => ({ default: module.SkinAnalysisResults })));
const ProductsManagement = lazy(() => import("../app/pages/admin/ProductsManagement").then((module) => ({ default: module.ProductsManagement })));
const ReportsAnalytics = lazy(() => import("../app/pages/admin/ReportsAnalytics").then((module) => ({ default: module.ReportsAnalytics })));
const AdminSettings = lazy(() => import("../app/pages/admin/AdminSettings").then((module) => ({ default: module.AdminSettings })));
const AdminEducationPage = lazy(() => import("../app/pages/admin/AdminEducationPage"));
const LandingPage = lazy(() => import("../app/pages/LandingPage").then((module) => ({ default: module.LandingPage })));
const CreateAccountPage = lazy(() => import("../app/pages/CreateAccountPage").then((module) => ({ default: module.CreateAccountPage })));
const QuestionnairePage = lazy(() => import("../app/pages/QuestionnairePage").then((module) => ({ default: module.QuestionnairePage })));
const UploadPage = lazy(() => import("../app/pages/UploadPage").then((module) => ({ default: module.UploadPage })));
const ResultsPage = lazy(() => import("../app/pages/ResultsPage").then((module) => ({ default: module.ResultsPage })));
const RoutinePage = lazy(() => import("../app/pages/RoutinePage").then((module) => ({ default: module.RoutinePage })));
const ProductsPage = lazy(() => import("../app/pages/ProductsPage").then((module) => ({ default: module.ProductsPage })));
const CheckoutPage = lazy(() => import("../app/pages/CheckoutPage").then((module) => ({ default: module.CheckoutPage })));
const ConfirmationPage = lazy(() => import("../app/pages/ConfirmationPage").then((module) => ({ default: module.ConfirmationPage })));
...
const ProfilePage = lazy(() => import("../app/pages/ProfilePage").then((module) => ({ default: module.ProfilePage })));
const ChatbotPage = lazy(() => import("../app/pages/ChatbotPage").then((module) => ({ default: module.ChatbotPage })));
const OrdersPage = lazy(() => import("../app/pages/OrdersPage").then((module) => ({ default: module.OrdersPage })));
const SignInPage = lazy(() => import("../app/pages/SignInPage").then((module) => ({ default: module.SignInPage })));
const PremiumPage = lazy(() => import("../app/pages/PremiumPage").then((module) => ({ default: module.PremiumPage })));
const ActivityPage = lazy(() => import("../app/pages/ActivityPage").then((module) => ({ default: module.ActivityPage })));
const OrderDetailsPage = lazy(() => import("../app/pages/OrderDetailsPage").then((module) => ({ default: module.OrderDetailsPage })));
const TrackPackagePage = lazy(() => import("../app/pages/TrackPackagePage").then((module) => ({ default: module.TrackPackagePage })));
